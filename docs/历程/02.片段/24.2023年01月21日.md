...
const list = [...document.querySelector('.xcomponent-table-body').querySelectorAll('.xcomponent-btn-helper')].filter(item => item.innerText === '详情');
for (let i = 0, len = list.length; i < len; i++) {
  ...
  let isItemNotOver = true
   await timeOut(500, () => isItemNotOver, () => {
