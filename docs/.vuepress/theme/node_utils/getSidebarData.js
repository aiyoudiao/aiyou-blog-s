/*
 * Filename: e:\newblog\my2022\aiyou-blog-s\docs\.vuepress\theme\node_utils\getSidebarData.js
 * Path: e:\newblog\my2022\aiyou-blog-s\docs\.vuepress\theme
 * Created Date: Saturday, February 19th 2022, 3:29:44 pm
 * Author: aiyoudiao
 * 
...
function readTocs(root) {
  ...
  files.forEach(name => {
    ...
    if (fs.statSync(file).isDirectory() && name !== '.vuepress' && name !== '首页') {
